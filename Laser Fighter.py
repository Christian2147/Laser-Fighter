...
ufos_killed = int(stats_text[16])
big_aliens_killed = int(stats_text[18])
medium_aliens_killed = int(stats_text[20])
small_aliens_killed = int(stats_text[22])
alien_deaths = int(stats_text[24])
damage_taken = int(stats_text[26])
alien_lasers_fired = int(stats_text[28])
jumps = int(stats_text[30])
...
# Lines 389 - 1577 is where all the different sprites(turtles) that are needed are created
# These turtles are set to their initial title mode state when they are created
...
classic_high_score_text.goto(-320, 80)
...
bosses_killed_text.goto(-320, 30)
...
red_bots_killed_text.goto(-320, -20)
...
yellow_bots_killed_text.goto(-320, -70)
...
blue_bots_killed_text.goto(-320, -120)
...
classic_deaths_text.goto(-320, -170)
...
classic_lasers_fired_text.goto(-320, -220)
...
alien_high_score_text.goto(320, 80)
...
big_aliens_killed_text.goto(320, -20)
...
medium_aliens_killed_text.goto(320, -70)
...
small_aliens_killed_text.goto(320, -120)
...
alien_deaths_text.goto(320, -170)
...
damage_taken_text.goto(320, -220)
...
alien_lasers_fired_text.goto(320, -270)
...
button_sound_button_frame.shape("Textures/Buttons/Sound_Button.gif")
...
player_shooting_sound_button_frame.shape("Textures/Buttons/Sound_Button.gif")
...
enemy_shooting_sound_button_frame.shape("Textures/Buttons/Sound_Button.gif")
...
player_death_sound_button_frame.shape("Textures/Buttons/Sound_Button.gif")
...
enemy_death_sound_button_frame.shape("Textures/Buttons/Sound_Button.gif")
...
player_hit_sound_button_frame.shape("Textures/Buttons/Sound_Button.gif")
...
enemy_hit_sound_button_frame.shape("Textures/Buttons/Sound_Button.gif")
...
go_right_control_button_frame.shape("Textures/Buttons/Control_Button.gif")
...
go_left_control_button_frame.shape("Textures/Buttons/Control_Button.gif")
...
shoot_control_button_frame.shape("Textures/Buttons/Control_Button.gif")
...
jump_control_button_frame.shape("Textures/Buttons/Control_Button.gif")
    ...
    if mode == "Alien_Mode":
        if player_head.direction == "right" and shoot_update == 0 and head_death_animation == 0:
            ...
            if god_mode == 0:
                ...
                stats_text = stats.readlines()
                stats.close()
                stats_text[28] = str(alien_lasers_fired) + "\n"
                stats_update = open("Config/Statistics.txt", "w")
                stats_update.writelines(stats_text)
                stats_update.close()
...
# The next 5 functions are for switching to different modes of the game. These are usually activated when the screen is clicked on specific coordinates on the screen
...
def launch_title_mode(x, y):
    ...
    if mode == "Settings":
        if (x > 96) and (x < 602) and (y > -316) and (y < -170):
            if button_sound == 1:
                winsound.PlaySound("Sound/Button_Sound.wav", winsound.SND_ASYNC)
...
# The next 7 functions are for toggling certain sounds on or off in the game
...
def toggle_button_sound(x, y):
    if (x > -612) and (x < 30) and (y > 164) and (y < 227):
        if button_sound == 1:
            winsound.PlaySound("Sound/Button_Sound.wav", winsound.SND_ASYNC)
        soundfile = open("Config/Sound.txt", "r")
...
def toggle_player_shooting_sound(x, y):
    if (x > -612) and (x < 30) and (y > 84) and (y < 147):
        if button_sound == 1:
            winsound.PlaySound("Sound/Button_Sound.wav", winsound.SND_ASYNC)
        soundfile = open("Config/Sound.txt", "r")
        sound = soundfile.readlines()
...
def toggle_enemy_shooting_sound(x, y):
    if (x > -612) and (x < 30) and (y > 4) and (y < 67):
        if button_sound == 1:
            winsound.PlaySound("Sound/Button_Sound.wav", winsound.SND_ASYNC)
        soundfile = open("Config/Sound.txt", "r")
        sound = soundfile.readlines()
...
def toggle_player_death_sound(x, y):
    if (x > -612) and (x < 30) and (y > -80) and (y < -10):
        if button_sound == 1:
            winsound.PlaySound("Sound/Button_Sound.wav", winsound.SND_ASYNC)
        soundfile = open("Config/Sound.txt", "r")
        sound = soundfile.readlines()
...
def toggle_enemy_death_sound(x, y):
    if (x > -612) and (x < 30) and (y > -160) and (y < -90):
        if button_sound == 1:
            winsound.PlaySound("Sound/Button_Sound.wav", winsound.SND_ASYNC)
        soundfile = open("Config/Sound.txt", "r")
        sound = soundfile.readlines()
...
def toggle_player_hit_sound(x, y):
    if (x > -612) and (x < 30) and (y > -240) and (y < -170):
        if button_sound == 1:
            winsound.PlaySound("Sound/Button_Sound.wav", winsound.SND_ASYNC)
        soundfile = open("Config/Sound.txt", "r")
        sound = soundfile.readlines()
...
def toggle_enemy_hit_sound(x, y):
    if (x > -612) and (x < 30) and (y > -320) and (y < -250):
        if button_sound == 1:
            winsound.PlaySound("Sound/Button_Sound.wav", winsound.SND_ASYNC)
        soundfile = open("Config/Sound.txt", "r")
        sound = soundfile.readlines()
...
def change_go_right_key(x, y):
    ...
    global message_output
    global updated_controls
    if (x > 97) and (x < 604) and (y > 155) and (y < 230):
        if button_sound == 1:
            winsound.PlaySound("Sound/Button_Sound.wav", winsound.SND_ASYNC)
...
def change_go_left_key(x, y):
    ...
    global message_output
    global updated_controls
    if (x > 97) and (x < 604) and (y > 70) and (y < 150):
        if button_sound == 1:
            winsound.PlaySound("Sound/Button_Sound.wav", winsound.SND_ASYNC)
...
def change_shoot_key(x, y):
    ...
    global message_output
    global updated_controls
    if (x > 97) and (x < 604) and (y > -5) and (y < 70):
        if button_sound == 1:
            winsound.PlaySound("Sound/Button_Sound.wav", winsound.SND_ASYNC)
...
def change_jump_key(x, y):
    ...
    global message_output
    global updated_controls
    if (x > 97) and (x < 604) and (y > -80) and (y < -10):
        if button_sound == 1:
            winsound.PlaySound("Sound/Button_Sound.wav", winsound.SND_ASYNC)
...
# The buttons text being yellow then allows the user to click the button and activate its function
...
while True:
    ...
    # Lines 2373 - 2412 are for what happens when title mode is toggled on and off
    ...
    if mode == "Title_Mode":
        ...
        version_number.write("Alpha 0.3.0a", align="center", font=("Courier", 24, "normal"))
    ...
    # Lines 2417 - 2495 are for what happens when classic mode is toggled on and off
    ...
    # Lines 2499 - 5621 is for what happens when alien mode is toggled on and off
    ...
    if mode == "Alien_Mode":
        ...
        # Lines 2520 - 2606 make more aliens visible as the score increases.
        ...
        # Lines 2618 - 2691 are for the players movement in alien mode
        ...
        # Lines 2696 - 2711 are for the player laser movement
        ...
        # Lines 2716 - 2823 are for the direction of both players and aliens
        ...
        # Lines 2829 - 3407 are for the alien speeds
        ...
        # Lines 3411 - 3428 are for configuring the boss aliens laser
        ...
        # Lines 3434 - 3609 are for setting the aliens texture as it is moving and changing directions
        ...
        # Lines 3614 - 4698 are for what happens when each of the aliens gets hit/dies
        ...
        if (player_head_laser.distance(alien1) < 53 and (alien1.xcor() - 15 < player_head_laser.xcor() < alien1.xcor() + 15)) and alien1_death == 0 and alien1.isvisible() and player_head_laser.isvisible():
            ...
            if god_mode == 0:
                ...
                stats_text = stats.readlines()
                stats.close()
                stats_text[22] = str(small_aliens_killed) + "\n"
                stats_update = open("Config/Statistics.txt", "w")
                stats_update.writelines(stats_text)
                stats_update.close()
        ...
        if (player_head_laser.distance(alien6) < 72 and (alien6.xcor() - 15 < player_head_laser.xcor() < alien6.xcor() + 15)) and alien6_health == 1 and alien6_death == 0 and alien6.isvisible() and player_head_laser.isvisible() and alien6_hit_delay == 0:
            ...
            if god_mode == 0:
                ...
                stats_text = stats.readlines()
                stats.close()
                stats_text[20] = str(medium_aliens_killed) + "\n"
                stats_update = open("Config/Statistics.txt", "w")
                stats_update.writelines(stats_text)
                stats_update.close()
            alien6_health = 0
        ...
        if (player_head_laser.distance(alien11) < 112 and (alien11.xcor() - 15 < player_head_laser.xcor() < alien11.xcor() + 15)) and alien11_health == 1 and alien11_death == 0 and alien11.isvisible() and player_head_laser.isvisible() and alien11_hit_delay == 0:
            ...
            if god_mode == 0:
                ...
                stats_text = stats.readlines()
                stats.close()
                stats_text[18] = str(big_aliens_killed) + "\n"
                stats_update = open("Config/Statistics.txt", "w")
                stats_update.writelines(stats_text)
                stats_update.close()
            alien11_health = 0
        ...
        # Lines 4703 - 4886 are for what happens when the player dies
        ...
        if player_health == 0 and death_occurring == 0 and god_mode == 0 and head_death_animation != 1:
            ...
            if god_mode == 0:
                ...
                stats_text = stats.readlines()
                stats.close()
                stats_text[24] = str(alien_deaths) + "\n"
                stats_update = open("Config/Statistics.txt", "w")
                stats_update.writelines(stats_text)
                stats_update.close()
            alien_random = random.randint(1, 2)
        ...
        # Lines 4892 - 5473 are for what happens when the player gets hit
        ...
        if death_occurring == 0 and player_health != 0 and (alien1.distance(player_head) < 70 and alien1.xcor() - 12.5 < player_head.xcor() < alien1.xcor() + 12.5) and god_mode == 0 and player_update == 0 and alien1_death == 0:
            ...
            if god_mode == 0:
                ...
                stats_text = stats.readlines()
                stats.close()
                stats_text[26] = str(damage_taken) + "\n"
                stats_update = open("Config/Statistics.txt", "w")
                stats_update.writelines(stats_text)
                stats_update.close()
        ...
        # Lines 5479 - 5621 are for what happens when alien mode is off
    ...
    # Lines 5626 - 5699 is for what happens when the stats mode is toggled on or off
    ...
    if mode == "Stats":
        ...
        classic_mode_label.write("Classic Mode", align="center", font=("Courier", 48, "bold"))
        alien_mode_label.clear()
        alien_mode_label.write("Alien Mode", align="center", font=("Courier", 48, "bold"))
        classic_high_score_text.clear()
        classic_high_score_text.write("High Score: {}".format(high_score_machine_war), align="center", font=("Courier", 30, "normal"))
        bosses_killed_text.clear()
        bosses_killed_text.write("Bosses Killed: {}".format(bosses_killed), align="center", font=("Courier", 30, "normal"))
        red_bots_killed_text.clear()
        red_bots_killed_text.write("Red Bots Killed: {}".format(red_bots_killed), align="center", font=("Courier", 30, "normal"))
        yellow_bots_killed_text.clear()
        yellow_bots_killed_text.write("Yellow Bots Killed: {}".format(yellow_bots_killed), align="center", font=("Courier", 30, "normal"))
        blue_bots_killed_text.clear()
        blue_bots_killed_text.write("Blue Bots Killed: {}".format(blue_bots_killed), align="center", font=("Courier", 30, "normal"))
        classic_deaths_text.clear()
        classic_deaths_text.write("Deaths: {}".format(classic_deaths), align="center", font=("Courier", 30, "normal"))
        classic_lasers_fired_text.clear()
        classic_lasers_fired_text.write("Lasers Fired: {}".format(classic_lasers_fired), align="center", font=("Courier", 30, "normal"))
        alien_high_score_text.clear()
        alien_high_score_text.write("High Score: {}".format(high_score_alien_mode), align="center", font=("Courier", 30, "normal"))
        ufos_killed_text.clear()
        ufos_killed_text.write("UFOs Killed: {}".format(ufos_killed), align="center", font=("Courier", 30, "normal"))
        big_aliens_killed_text.clear()
        big_aliens_killed_text.write("Big Aliens Killed: {}".format(big_aliens_killed), align="center", font=("Courier", 30, "normal"))
        medium_aliens_killed_text.clear()
        medium_aliens_killed_text.write("Medium Aliens Killed: {}".format(medium_aliens_killed), align="center", font=("Courier", 30, "normal"))
        small_aliens_killed_text.clear()
        small_aliens_killed_text.write("Small Aliens Killed: {}".format(small_aliens_killed), align="center", font=("Courier", 30, "normal"))
        alien_deaths_text.clear()
        alien_deaths_text.write("Deaths: {}".format(alien_deaths), align="center", font=("Courier", 30, "normal"))
        damage_taken_text.clear()
        damage_taken_text.write("Damage Taken: {}".format(damage_taken), align="center", font=("Courier", 30, "normal"))
        alien_lasers_fired_text.clear()
        alien_lasers_fired_text.write("Lasers Fired: {}".format(alien_lasers_fired), align="center", font=("Courier", 30, "normal"))
        jumps_text.clear()
        jumps_text.write("Jumps: {}".format(jumps), align="center", font=("Courier", 30, "normal"))
    ...
    # Lines 5703 - 5840 are for when the settings mode is toggled on or off
    ...
    if mode == "Settings":
        ...
        go_back_button_frame.shape("Textures/Buttons/Settings_Main_Menu_Button.gif")
        go_back_button_frame.showturtle()
    ...
    # Lines 5847 - 5917 activate certain functions when certain buttons are clicked
    # The way this works is that the code checks if any of the buttons have yellow text
    # If a button has yellow text, that means that the users is hovering over them and is allowed to click them
    # If the user clicks them, then the buttons function is activated
    ...
    # This is used for when the player fires his laser.
    # If it reaches the edge of the screen, it goes back to him, ready to be fired agian
    ...
    # Lines 5935 - 6322 is used for the updating and firing the lasers of all the enemies in classic mode
    ...
    # Lines 6328 - 7268 is for what happens when each of the enemies die in classic mode
    ...
    # Lines 7273 - 7464 are for what happens when the player gets hit and dies in classic mode
    ...
    # Lines 7470 - 8136 are for the movement of all the enemies in classic mode.
    ...
    # Lines 8141 - 8174 are used to check if the sounds are still on or still off
    ...
    # Lines 8178 - 8195 are used to check the score and both high scores every tick and update them if needed
    ...
    # Lines 8199 - 8207 are used to write the score and high score on the screen when playing one of the game modes
    ...
    # Lines 8211 - 8220 are used to correctly set the tick delays for each of the modes of the game

...
def main():
    ...
    while True:
        ...
        # Limit the frames if VSync is on
        if elapsed_time >= MONITOR_DELAY or settings.vsync == 0:
            """
            ...
            if screen.mode == "Machine_Mode" and screen.mode == "Alien_Mode":
                if screen.tick_update % 25 == 0:

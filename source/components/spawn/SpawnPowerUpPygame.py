...
class SpawnYellowPowerUpIndicator:
    """
        ...
        Attributes:
            yellow_power_up_indicator_sprite (list): Contains the yellow power up indicator sprite once it is spawned
    ...
    def __del__(self):
        ...
        del self.yellow_power_up_indicator_sprite
...
class SpawnBluePowerUpIndicator:
    """
        ...
        Attributes:
            blue_power_up_indicator_sprite (list): Contains the blue power up indicator sprite once it is spawned
    ...
    def __del__(self):
        ...
        del self.blue_power_up_indicator_sprite
...
class SpawnExtraPowerUpIndicator:
    """
        ...
        Attributes:
            extra_power_up_indicator_sprite (list): Contains the extra power up indicator sprite once it is spawned
    ...
    def __del__(self):
        ...
        del self.extra_power_up_indicator_sprite
        del self.extra_power_up_indicator_index

    def spawn_extra_power_up_indicator(self, mode):
        """
